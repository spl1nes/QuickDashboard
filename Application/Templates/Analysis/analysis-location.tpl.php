...
<?php if(in_array($this->request->getData('location'), ['Export', 'Domestic', 'DE'])) : ?><p>There are <?= $this->getData('newCustomers'); ?> new customers during the last 12 month and <?= $this->getData('lostCustomers'); ?> customers are lost compared to the previous 12 month.</p><?php endif; ?>
