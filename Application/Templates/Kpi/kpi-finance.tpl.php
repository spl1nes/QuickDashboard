...
<table>
    ...
    <tr>
    	...
    	<td><?= number_format($month < 1 ? 0 : getAccountSum([1600, 1602, 1605, 1607], $year, 1, $balance)/getAccountSumSingle(array_merge(\QuickDashboard\Application\Models\StructureDefinitions::PL_ACCOUNTS['COGS Material'], \QuickDashboard\Application\Models\StructureDefinitions::PL_ACCOUNTS['COGS Services']), $year, 1, $pl) * -30, 0, ',', '.'); ?>
    	<td><?= number_format($month < 2 ? 0 : getAccountSum([1600, 1602, 1605, 1607], $year, 2, $balance)/getAccountSumSingle(array_merge(\QuickDashboard\Application\Models\StructureDefinitions::PL_ACCOUNTS['COGS Material'], \QuickDashboard\Application\Models\StructureDefinitions::PL_ACCOUNTS['COGS Services']), $year, 2, $pl) * -30, 0, ',', '.'); ?>
    	<td><?= number_format($month < 3 ? 0 : getAccountSum([1600, 1602, 1605, 1607], $year, 3, $balance)/getAccountSumSingle(array_merge(\QuickDashboard\Application\Models\StructureDefinitions::PL_ACCOUNTS['COGS Material'], \QuickDashboard\Application\Models\StructureDefinitions::PL_ACCOUNTS['COGS Services']), $year, 3, $pl) * -30, 0, ',', '.'); ?>
    	<td><?= number_format($month < 4 ? 0 : getAccountSum([1600, 1602, 1605, 1607], $year, 4, $balance)/getAccountSumSingle(array_merge(\QuickDashboard\Application\Models\StructureDefinitions::PL_ACCOUNTS['COGS Material'], \QuickDashboard\Application\Models\StructureDefinitions::PL_ACCOUNTS['COGS Services']), $year, 4, $pl) * -30, 0, ',', '.'); ?>
    	<td><?= number_format($month < 5 ? 0 : getAccountSum([1600, 1602, 1605, 1607], $year, 5, $balance)/getAccountSumSingle(array_merge(\QuickDashboard\Application\Models\StructureDefinitions::PL_ACCOUNTS['COGS Material'], \QuickDashboard\Application\Models\StructureDefinitions::PL_ACCOUNTS['COGS Services']), $year, 5, $pl) * -30, 0, ',', '.'); ?>
    	<td><?= number_format($month < 6 ? 0 : getAccountSum([1600, 1602, 1605, 1607], $year, 6, $balance)/getAccountSumSingle(array_merge(\QuickDashboard\Application\Models\StructureDefinitions::PL_ACCOUNTS['COGS Material'], \QuickDashboard\Application\Models\StructureDefinitions::PL_ACCOUNTS['COGS Services']), $year, 6, $pl) * -30, 0, ',', '.'); ?>
    	<td><?= number_format($month < 7 ? 0 : getAccountSum([1600, 1602, 1605, 1607], $year, 7, $balance)/getAccountSumSingle(array_merge(\QuickDashboard\Application\Models\StructureDefinitions::PL_ACCOUNTS['COGS Material'], \QuickDashboard\Application\Models\StructureDefinitions::PL_ACCOUNTS['COGS Services']), $year, 7, $pl) * -30, 0, ',', '.'); ?>
    	<td><?= number_format($month < 8 ? 0 : getAccountSum([1600, 1602, 1605, 1607], $year, 8, $balance)/getAccountSumSingle(array_merge(\QuickDashboard\Application\Models\StructureDefinitions::PL_ACCOUNTS['COGS Material'], \QuickDashboard\Application\Models\StructureDefinitions::PL_ACCOUNTS['COGS Services']), $year, 8, $pl) * -30, 0, ',', '.'); ?>
    	<td><?= number_format($month < 9 ? 0 : getAccountSum([1600, 1602, 1605, 1607], $year, 9, $balance)/getAccountSumSingle(array_merge(\QuickDashboard\Application\Models\StructureDefinitions::PL_ACCOUNTS['COGS Material'], \QuickDashboard\Application\Models\StructureDefinitions::PL_ACCOUNTS['COGS Services']), $year, 9, $pl) * -30, 0, ',', '.'); ?>
    	<td><?= number_format($month < 10 ? 0 : getAccountSum([1600, 1602, 1605, 1607], $year, 10, $balance)/getAccountSumSingle(array_merge(\QuickDashboard\Application\Models\StructureDefinitions::PL_ACCOUNTS['COGS Material'], \QuickDashboard\Application\Models\StructureDefinitions::PL_ACCOUNTS['COGS Services']), $year, 10, $pl) * -30, 0, ',', '.'); ?>
    	<td><?= number_format($month < 11 ? 0 : getAccountSum([1600, 1602, 1605, 1607], $year, 11, $balance)/getAccountSumSingle(array_merge(\QuickDashboard\Application\Models\StructureDefinitions::PL_ACCOUNTS['COGS Material'], \QuickDashboard\Application\Models\StructureDefinitions::PL_ACCOUNTS['COGS Services']), $year, 11, $pl) * -30, 0, ',', '.'); ?>
    	<td><?= number_format($month < 12 ? 0 : getAccountSum([1600, 1602, 1605, 1607], $year, 12, $balance)/getAccountSumSingle(array_merge(\QuickDashboard\Application\Models\StructureDefinitions::PL_ACCOUNTS['COGS Material'], \QuickDashboard\Application\Models\StructureDefinitions::PL_ACCOUNTS['COGS Services']), $year, 12, $pl) * -30, 0, ',', '.'); ?>
    <tr>
        <th>Stock
    ...
    <tr>
        ...
        <td><?= number_format($month < 1 ? 0 : getAccountSum([3970, 3985, 3975, 3980, 3981, 3982, 3983, 3984], $year, 1, $balance)/getAccountSumSingle(\QuickDashboard\Application\Models\StructureDefinitions::PL_ACCOUNTS['Sales'], $year, 1, $pl) * -30, 0, ',', '.'); ?>
        <td><?= number_format($month < 2 ? 0 : getAccountSum([3970, 3985, 3975, 3980, 3981, 3982, 3983, 3984], $year, 2, $balance)/getAccountSumSingle(\QuickDashboard\Application\Models\StructureDefinitions::PL_ACCOUNTS['Sales'], $year, 2, $pl) * -30, 0, ',', '.'); ?>
        <td><?= number_format($month < 3 ? 0 : getAccountSum([3970, 3985, 3975, 3980, 3981, 3982, 3983, 3984], $year, 3, $balance)/getAccountSumSingle(\QuickDashboard\Application\Models\StructureDefinitions::PL_ACCOUNTS['Sales'], $year, 3, $pl) * -30, 0, ',', '.'); ?>
        <td><?= number_format($month < 4 ? 0 : getAccountSum([3970, 3985, 3975, 3980, 3981, 3982, 3983, 3984], $year, 4, $balance)/getAccountSumSingle(\QuickDashboard\Application\Models\StructureDefinitions::PL_ACCOUNTS['Sales'], $year, 4, $pl) * -30, 0, ',', '.'); ?>
        <td><?= number_format($month < 5 ? 0 : getAccountSum([3970, 3985, 3975, 3980, 3981, 3982, 3983, 3984], $year, 5, $balance)/getAccountSumSingle(\QuickDashboard\Application\Models\StructureDefinitions::PL_ACCOUNTS['Sales'], $year, 5, $pl) * -30, 0, ',', '.'); ?>
        <td><?= number_format($month < 6 ? 0 : getAccountSum([3970, 3985, 3975, 3980, 3981, 3982, 3983, 3984], $year, 6, $balance)/getAccountSumSingle(\QuickDashboard\Application\Models\StructureDefinitions::PL_ACCOUNTS['Sales'], $year, 6, $pl) * -30, 0, ',', '.'); ?>
        <td><?= number_format($month < 7 ? 0 : getAccountSum([3970, 3985, 3975, 3980, 3981, 3982, 3983, 3984], $year, 7, $balance)/getAccountSumSingle(\QuickDashboard\Application\Models\StructureDefinitions::PL_ACCOUNTS['Sales'], $year, 7, $pl) * -30, 0, ',', '.'); ?>
        <td><?= number_format($month < 8 ? 0 : getAccountSum([3970, 3985, 3975, 3980, 3981, 3982, 3983, 3984], $year, 8, $balance)/getAccountSumSingle(\QuickDashboard\Application\Models\StructureDefinitions::PL_ACCOUNTS['Sales'], $year, 8, $pl) * -30, 0, ',', '.'); ?>
        <td><?= number_format($month < 9 ? 0 : getAccountSum([3970, 3985, 3975, 3980, 3981, 3982, 3983, 3984], $year, 9, $balance)/getAccountSumSingle(\QuickDashboard\Application\Models\StructureDefinitions::PL_ACCOUNTS['Sales'], $year, 9, $pl) * -30, 0, ',', '.'); ?>
        <td><?= number_format($month < 10 ? 0 : getAccountSum([3970, 3985, 3975, 3980, 3981, 3982, 3983, 3984], $year, 10, $balance)/getAccountSumSingle(\QuickDashboard\Application\Models\StructureDefinitions::PL_ACCOUNTS['Sales'], $year, 10, $pl) * -30, 0, ',', '.'); ?>
        <td><?= number_format($month < 11 ? 0 : getAccountSum([3970, 3985, 3975, 3980, 3981, 3982, 3983, 3984], $year, 11, $balance)/getAccountSumSingle(\QuickDashboard\Application\Models\StructureDefinitions::PL_ACCOUNTS['Sales'], $year, 11, $pl) * -30, 0, ',', '.'); ?>
        <td><?= number_format($month < 12 ? 0 : getAccountSum([3970, 3985, 3975, 3980, 3981, 3982, 3983, 3984], $year, 12, $balance)/getAccountSumSingle(\QuickDashboard\Application\Models\StructureDefinitions::PL_ACCOUNTS['Sales'], $year, 12, $pl) * -30, 0, ',', '.'); ?>
</table>